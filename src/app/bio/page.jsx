...
export default function Socials() {
  return (
    <>
      <div className="socials-content py-10 bg-socials bg-cover bg-center bg-no-repeat">
        ...
        <h2 className="font-mono font-bold text-2xl text-center mt-5 h2">
          Paula Peñaflor
        </h2>
        <p className="font-mono font-medium text-lg text-center mt-8">
          Loan Officer
        </p>
        {/**Social items */}
        <div className="flex justify-center items-center mt-6">
          ...
          >
            <span className="flex items-center justify-center">WHATSAPP <RiWhatsappFill className="ml-2"/></span>
          </a>
        </div>
        <div className="flex justify-center items-center mt-2">
          <a
            ...
            className="cursor-pointer font-medium w-56 text-center bg-gray-600 rounded-full  hover:bg-orange-100 hover:text-twitter-blue  px-4 py-2 mb-2 sm:mb-0 text-white "
          >
            <span className="flex items-center justify-center">FACEBOOK <RiFacebookBoxFill className="ml-2"/></span>
          </a>
        </div>
        <div className="flex justify-center items-center mt-2">
          <a
            ...
            className="cursor-pointer font-medium w-56 text-center bg-gray-600 rounded-full  hover:bg-orange-100 hover:text-twitter-blue  px-4 py-2 mb-2 sm:mb-0 text-white "
          >
            <span className="flex items-center justify-center">INSTAGRAM <RiInstagramFill className="ml-2"/></span>
          </a>
        </div>
        <div className="flex justify-center items-center mt-2">
          <a
            ...
            className="cursor-pointer font-medium w-56 text-center bg-gray-600 rounded-full  hover:bg-orange-100 hover:text-twitter-blue  px-4 py-2 mb-2 sm:mb-0 text-white "
          >
            <span className="flex items-center justify-center">WEBSITE <TbWorld className="ml-2"/></span>
          </a>
        </div>
